...
for i in range(len(df)):
        ...
        b_info = driver.find_element(By.XPATH, "// p[contains(text(), 'Basic information')]") #find Basic information label
        b_info = b_info.find_element(By.XPATH, '..') #find Basic information block
        ...
        for c in range(len(cols)):
                ...
                desc_label = driver.find_element(By.XPATH, "// label[contains(text()," + "'" + col_name + "'" + ")]") #find description bloc
                desc_box  = desc_label.find_element(By.XPATH, '..') #find box with description
                desc_input = desc_box.find_elements(By.TAG_NAME, 'textarea')[0] #find text area to enter text
